...
return (
  <div className="fixed h-full w-1/11 bg-teal p-4 flex flex-col justify-between items-center">
    ...
    <div className="w-full flex flex-col items-center space-y-8 flex-grow">
      ...
      <RxDashboard
        className={`text-3xl p- cursor-pointer ${
          isDashboardRoute ? 'bg-blue-700 text-white' : ''
        }`}
      />
      </Link>
      ...
      <RiUserLine
        className={`text-3xl cursor-pointer ${
          isProfileRoute ? 'bg-blue-700 p-4 text-white' : ''
        }`}
      />
      </Link>
    </div>
